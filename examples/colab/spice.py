# -*- coding: utf-8 -*-
"""Clase 45 - Spice.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1i5L_hh4MVwg8VRbv5iZD1ZAgu2GFtp2H
...
INPUT_SOURCE = "/content/sample_data/simpsong_02.wav" #@param ["https://storage.googleapis.com/download.tensorflow.org/data/c-scale-metronome.wav", "RECORD", "UPLOAD", "./drive/My Drive/YOUR_MUSIC_FILE.wav", "/content/sample_data/simpsong_02.wav"] {allow-input: true}
...
elif INPUT_SOURCE.startswith('/content/'):
  try:
    from google.colab import drive
  except ImportError:
    print("ImportError: files from google.colab seems to not be available")
